...
public interface DriverPortBuilder {

	public static DriverPortBuilder getInstance() {
		return ServiceLoader.load(DriverPortBuilder.class).stream().findFirst().orElseThrow(() -> new RuntimeException("No DriverPortBuilder provider found")).get();
	}
